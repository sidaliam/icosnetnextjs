    ...
    <div className="container">
      <div className="row mb-60 mb-sm-40">
        <div className="col-lg-8 offset-lg-2 text-center mb-md-30">
          <h2 className="section-caption-fancy mb-20 mb-xs-10">Notre Blog</h2>
          <h3 className="section-title mb-0 mb-xs-20">
          Découvrez les dernières nouvelles de notre entreprise sur notre blog.
          </h3>
        </div>
        <div className="col-lg-2 d-flex align-items-end">
          <div className="local-scroll text-center text-lg-end w-100">
            <Link
              ...
              data-link-animate="y"
            >
              Notre Blog <i className="mi-arrow-right size-24" />
            </Link>
          </div>
        </div>
      </div>
