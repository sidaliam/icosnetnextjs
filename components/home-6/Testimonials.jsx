  ...
  return (
    <div className="container position-relative">
      <div className="row">
        ...
        <div className="col-lg-5 col-xl-5 d-flex align-items-center mb-md-60 mb-sm-40">
          <div className="w-100">
            ...
            Nous aidons les marques à se démarquer dans un paysage numérique en constante évolution.
            </h3>
            <p className="section-descr mb-30">
            Un site web statique stocke un fichier unique pour chaque page du site. Chaque fois que cette page est demandée, le même contenu est renvoyé.
            </p>
            {/* Numbers */}
            <div className="row">
      ...
      <div className="page-section pb-0 text-center">
        <h3 className="section-title-tiny">De grandes entreprises nous font confiance</h3>
        <Swiper
          spaceBetween={0}
          slidesPerView={6}
          watchSlidesProgress
