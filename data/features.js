...
export const features3 = [
  { text: "Deux systèmes de climatisation redondants." },
  { text: "Connectivité redondante 2 Gb/2.​" },
  { text: "Système anti incendie et extinction automatique de haute performance.​" },
  { text: "Système de télésurveillance IP. ​" },
  { text: "Un accès hautement sécurisé." },
  
  { text: "Sécurité physique 24/7.​​" },
